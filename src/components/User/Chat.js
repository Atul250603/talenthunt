    ...
    return(
        <div className="w-full h-screen overflow-y-hidden bg-slate-100 flex">
            <div className="w-[89%] bg-white rounded-xl my-2 relative left-[10%] flex flex-col">
                {(data)?<div className='w-full h-full'><div className="flex items-center gap-2 bg-slate-200 rounded-lg mx-2 my-2 px-2 py-2 h-[10%] ">
                ...
                </div></div></div>:<div className='w-full h-full font-semibold flex items-center justify-center'>Loading....</div>}
            </div>
        </div>
    )
}
